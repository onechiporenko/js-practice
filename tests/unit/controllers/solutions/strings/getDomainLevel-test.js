...
test('test1', function(assert) {
  ...
  assert.equal(controller.getDomainLevel('http://google.com'), 2, `('http://google.com') -> 2`);
});
...
test('test5', function(assert) {
  var controller = this.subject();
  assert.equal(controller.getDomainLevel('https://google.com'), 2, `('https://google.com') -> 2`);
});
...
test('test9', function(assert) {
  var controller = this.subject();
  assert.equal(controller.getDomainLevel('http://mail.google.com'), 3, `('http://mail.google.com') -> 3`);
});
...
test('test13', function(assert) {
  var controller = this.subject();
  assert.equal(controller.getDomainLevel('https://mail.google.com'), 3, `('https://mail.google.com') -> 3`);
});
